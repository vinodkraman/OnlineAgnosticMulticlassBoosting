...
def main():
    ...
    #should have a predict and an update portion. In the prediction, we combine the hypothesis and sample
    #to update, we run the OCO algorithm. We should abstract away as usual. 
